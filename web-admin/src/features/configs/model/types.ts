...
export type ConfigFieldType =
  "STRING" | "INTEGER" | "LONG" | "DECIMAL" | "BOOLEAN" | "ENUM" | "STRING_LIST" | "OBJECT";

export type ConfigActivationPolicy = "DYNAMIC" | "RESTART_REQUIRED";
export type ConfigEditPolicy = "ADMIN_EDITABLE" | "READ_ONLY";
export type ConfigValueSource = "CODE_DEFAULT" | "DATABASE_OVERRIDE" | "INVALID_DATABASE_FALLBACK";
export type ConfigManagementStatus =
  "DEFAULT_VALUE" | "CONFIGURED" | "INVALID_DATABASE_VALUE" | "RESTART_REQUIRED" | "READ_ONLY";
