...
import { formatDateTime, formatDecimal } from "../utils/formatter";
...
const canView = computed(() => hasResourceCodeAccess("diagnostic-view"));
const canStart = computed(() => hasResourceCodeAccess("diagnostic-start"));
const canEdit = computed(() => hasResourceCodeAccess("diagnostic-edit"));
const canStop = computed(() => hasResourceCodeAccess("diagnostic-stop"));
