...
/**
 * BeanPostProcessor that wraps all DataSource beans with DiagnosticMonitoringDataSource to enable
 * SQL execution monitoring and connection pool state tracking.
 *
...
public class DiagnosticDataSourceBeanPostProcessor implements BeanPostProcessor {
  ...
  public DiagnosticDataSourceBeanPostProcessor(
  ...
  /**
   * Wraps DataSource beans with DiagnosticMonitoringDataSource and registers them with the
   * DbPoolStateCollector. Skips beans that are already DiagnosticMonitoringDataSource instances.
   */
  @Override
  public Object postProcessAfterInitialization(Object bean, String beanName) throws BeansException {
    ...
    DiagnosticMonitoringDataSource wrapped =
        new DiagnosticMonitoringDataSource(
            beanName, dataSource, runtimeManager, sqlExecutionObserver);
