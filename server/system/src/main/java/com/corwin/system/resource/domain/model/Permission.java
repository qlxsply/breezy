 ...
 *
 * <p>Represents a granular permission code that can be assigned to roles
 * and bound to resources. Each permission has a unique code, a display name,
 * and a user scope that determines which user types can be granted this permission.</p>
 *
