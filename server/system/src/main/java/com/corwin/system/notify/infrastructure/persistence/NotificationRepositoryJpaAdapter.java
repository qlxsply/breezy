 ...
 *
 * <p>Delegates standard CRUD operations to {@link NotificationJpaRepository} and dynamic page
 * queries to {@link NotificationMybatisMapper}.
 *
...
public class NotificationRepositoryJpaAdapter implements NotificationRepository {
  ...
  @Override
  public List<Notification> findByUserIdAndUserTypeAndIsReadFalseOrderByCreatedAtDesc(
      Long userId, UserType userType) {
    return repo.findByUserIdAndUserTypeAndIsReadFalseOrderByCreatedAtDesc(userId, userType);
  }

  @Override
  public Optional<Notification> findByIdAndUserIdAndUserType(
      Long id, Long userId, UserType userType) {
  ...
  public List<Notification>
    ...
    return repo.findByUserIdAndUserTypeAndIsReadFalseAndCreatedAtAfterOrderByCreatedAtDesc(
