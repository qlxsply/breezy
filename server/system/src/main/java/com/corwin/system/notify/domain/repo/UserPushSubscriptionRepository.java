 ...
 *
 * <p>Provides methods for querying user push subscriptions by user, device, and active status.
 *
 * @author Corwin 2026/3/19
 */
public interface UserPushSubscriptionRepository
    extends DomainRepository<UserPushSubscription, Long> {
   ...
   */
  Optional<UserPushSubscription> findByUserIdAndUserTypeAndDeviceId(
      Long userId, UserType userType, String deviceId);
   ...
   */
  List<UserPushSubscription> findByUserIdAndUserTypeOrderByUpdatedAtDesc(
