 ...
 * 用户应用包。
 *
 * <p>表示一组用户共享的应用权益集合，例如普通用户、VIP1、VIP2、企业版。</p>
 *
 * @author Corwin
 */
@Getter
@Entity
@Table(name = "sys_user_application_package",
        indexes = {@Index(name = "idx_sys_user_application_package_code", columnList = "package_code", unique = true),
...
public class UserApplicationPackage {
     ...
     */
    public UserApplicationPackage(String packageCode, String packageName, UserApplicationPackageType packageType,
            String description, Boolean defaultPackage, Boolean systemBuiltIn, Integer displayOrder, Long operator) {
     ...
     * @param operator       操作人用户 ID
     */
    public void update(String packageCode, String packageName, UserApplicationPackageType packageType,
            String description, Boolean defaultPackage, Integer displayOrder, Long operator) {
        this.packageCode = packageCode;
        this.packageName = packageName;
        this.packageType = packageType;
        this.description = description;
