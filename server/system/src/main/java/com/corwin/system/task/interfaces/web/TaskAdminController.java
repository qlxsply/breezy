...
/**
 * REST controller for task administration operations. Provides endpoints for listing, configuring,
 * publishing, stopping, and running tasks.
 *
...
public class TaskAdminController {
  ...
  public ApiResponse<List<TaskRes>> list() {
    return ApiResponse.ok(
        taskAppService.listTasks().stream().map(TaskAdminController::toRes).toList());
  }
  ...
  public ApiResponse<Boolean> updateConfig(
      @PathVariable String code, @RequestBody UpdateTaskConfigReq req) {
