 ...
 */
public enum PermissionUserScope implements DictEnumDefinition {
    INTERNAL("账号", DictTagColor.PRIMARY_BLUE, DictTagType.INFO),
    EXTERNAL("用户", DictTagColor.SUCCESS_GREEN, DictTagType.SUCCESS),
    COMMON("全部用户", DictTagColor.SLATE, DictTagType.INFO);

    private final String label;
    private final DictTagColor tagColor;
    private final DictTagType tagType;

    PermissionUserScope(String label, DictTagColor tagColor, DictTagType tagType) {
        this.label = label;
