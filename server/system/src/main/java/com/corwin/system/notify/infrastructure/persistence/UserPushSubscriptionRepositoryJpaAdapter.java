 ...
 *
 * <p>Delegates persistence operations to {@link UserPushSubscriptionJpaRepository}.
 *
...
public class UserPushSubscriptionRepositoryJpaAdapter implements UserPushSubscriptionRepository {
  ...
  @Override
  public Optional<UserPushSubscription> findByUserIdAndUserTypeAndDeviceId(
      Long userId, UserType userType, String deviceId) {
    return repo.findByUserIdAndUserTypeAndDeviceId(userId, userType, deviceId);
  }

  @Override
  public List<UserPushSubscription> findByUserIdAndUserTypeAndActiveTrue(
      Long userId, UserType userType) {
    return repo.findByUserIdAndUserTypeAndActiveTrue(userId, userType);
  }

  @Override
  public List<UserPushSubscription> findByUserIdAndUserTypeOrderByUpdatedAtDesc(
      Long userId, UserType userType) {
