 ...
 * 用户包应用授权。
 *
 * <p>表示用户应用包对产品应用的访问授权，并定义该授权覆盖完整功能或部分功能。</p>
 *
 * @author Corwin
 */
@Getter
@Entity
@Table(name = "sys_user_package_application_access", indexes = {
        @Index(name = "idx_sys_user_package_application_access_unique", columnList = "package_id,application_id",
                unique = true),
        @Index(name = "idx_sys_user_package_application_access_package_id", columnList = "package_id"),
        @Index(name = "idx_sys_user_package_application_access_application_id", columnList = "application_id"),
        @Index(name = "idx_sys_user_package_application_access_scope", columnList = "feature_access_scope")})
public class UserPackageApplicationAccess {
     ...
     *
     * <p>
     * FULL 表示拥有应用下全部已启用功能，后续新增功能自动可用。
     * PARTIAL 表示仅拥有显式授权功能，后续新增功能默认不可用。
     * </p>
     */
     ...
     */
    public UserPackageApplicationAccess(Long packageId, Long applicationId,
            ApplicationFeatureAccessScope featureAccessScope, Boolean systemBuiltIn, Long operator) {
     ...
     * 设置为完整功能访问。
     *
     * <p>设置为 FULL 后，业务层不应再维护该包在当前应用下的功能授权明细。</p>
     *
     * @param operator 操作人用户 ID
     */
     ...
     * 设置为部分功能访问。
     *
     * <p>设置为 PARTIAL 后，业务层应通过 {@link UserPackageFeatureAccess} 维护可用功能明细。</p>
     *
     * @param operator 操作人用户 ID
     */
