...
/**
 * Resolved audit operation metadata.
 * Holds the resource, action, description, severity level, recording flags,
 * and application code derived from {@link Audit} and {@code ApiMeta} annotations.
 *
