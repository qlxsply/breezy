...
public final class ScheduleRules {
  ...
  public static FixedIntervalRule fixedDelay(Duration delay, Instant startAt) {
    return new FixedIntervalRule(
        Objects.requireNonNull(delay, "delay required"),
        Objects.requireNonNull(startAt, "startAt required"),
        IntervalMode.FIXED_DELAY);
  }
  ...
  public static DailyRule daily(int hour, int minute, ZoneId zoneId) {
    return new DailyRule(
        LocalTime.of(hour, minute), Objects.requireNonNull(zoneId, "zoneId required"));
  }
  ...
  public static WeeklyRule weekly(DayOfWeek dayOfWeek, int hour, int minute) {
    return new WeeklyRule(
        Set.of(Objects.requireNonNull(dayOfWeek, "dayOfWeek required")),
  ...
  public static MonthlyRule monthly(int dayOfMonth, int hour, int minute) {
    return new MonthlyRule(
        MonthlyDayMode.EXACT_DAY, dayOfMonth, LocalTime.of(hour, minute), HighDate.zone());
  }
  ...
  public static MonthlyRule monthlyLastDay(int hour, int minute) {
    return new MonthlyRule(
        MonthlyDayMode.LAST_DAY, null, LocalTime.of(hour, minute), HighDate.zone());
  }
