...
/**
 * Repository interface for {@link PhysicalFile} entity. Provides data access for physical file
 * records, including hash-based lookup and reference count management.
 *
