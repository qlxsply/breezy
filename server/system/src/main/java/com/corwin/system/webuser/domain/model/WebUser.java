...
/**
 * Aggregate root for the external web user account. Stores account status, registration info, login
 * tracking, and token version for revocation.
 *
...
public class WebUser {
  ...
  public WebUser(
      String displayName,
      String nickname,
      WebUserRegisterMethod registerMethod,
      WebUserRegisterChannel registerChannel,
