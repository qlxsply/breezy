...
/**
 * Annotation to mark a type or method for audit logging.
 * Specifies the resource, action, severity level, description,
 * and whether to record request/response payloads in the audit trail.
 *
...
public @interface Audit {
    ...
    /**
     * Optional custom description of the audit event.
     * If left empty, a default description is generated from resource and action labels.
     */
