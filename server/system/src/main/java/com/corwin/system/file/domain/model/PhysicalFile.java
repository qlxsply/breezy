 ...
 *
 * <p>Files are de-duplicated by their SHA-256 hash. Multiple logical files may reference the same
 * physical file. The reference count tracks how many logical references exist.
 *
...
public class PhysicalFile {
  ...
  public PhysicalFile(
      String hash, String relativePath, String fileName, Long fileSize, String contentType) {
  ...
  /**
   * Increments the reference count for this physical file. Called when a new logical file
   * references this physical file.
   */
  ...
  /**
   * Decrements the reference count for this physical file. When the count reaches zero, the file
  ...
  /**
   * Returns {@code true} if this physical file has no remaining references and can be safely
   * deleted from disk.
   */
