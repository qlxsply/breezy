...
/**
 * Command object for updating a configuration value. Encapsulates the config code and the raw value
 * to be set.
 *
 * @author Corwin 2026/1/11
 */
public record UpdateConfigValueCommand(String code, String rawValue) {
