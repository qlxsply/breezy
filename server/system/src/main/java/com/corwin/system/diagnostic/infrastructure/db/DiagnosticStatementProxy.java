...
/**
 * JDBC proxy that intercepts Statement method calls to record SQL execution metrics via
 * SqlExecutionObserver. Supports prepared, callable, and batch statements.
 *
...
public final class DiagnosticStatementProxy implements InvocationHandler {
  ...
  private DiagnosticStatementProxy(
  ...
  public static Statement wrap(
    ...
    return (Statement)
        Proxy.newProxyInstance(
            ...
            new DiagnosticStatementProxy(
                dataSourceName, statement, preparedSql, runtimeManager, sqlExecutionObserver));
  }
