...
public class SystemResourceAdminController {
    ...
    @GetMapping("/tree")
    @Authorize(userTypes = {UserType.INTERNAL}, permissions = {"res.view"})
    ...
    @PostMapping
    @Authorize(userTypes = {UserType.INTERNAL}, permissions = {"res.add"})
    ...
    @PutMapping("/{id}")
    @Authorize(userTypes = {UserType.INTERNAL}, permissions = {"res.edit"})
    ...
    @DeleteMapping("/{id}")
    @Authorize(userTypes = {UserType.INTERNAL}, permissions = {"res.del"})
    public ApiResponse<Boolean> delete(@PathVariable Long id) {
        return ApiResponse.ok(systemResourceAdminService.delete(id));
    }

    @GetMapping("/{resourceId}/permissions")
    @Authorize(userTypes = {UserType.INTERNAL}, permissions = {"res.perm.view"})
    ...
    @Authorize(userTypes = {UserType.INTERNAL}, permissions = {"res.perm.edit"})
