 ...
 *
 * <p>Stores browser push subscription details including endpoint, encryption keys, and tracks push
...
@Entity
@Table(
    name = "sys_user_push_subscription",
    indexes = {@Index(name = "idx_push_user_active", columnList = "user_type, user_id, active")},
    uniqueConstraints = {
      @UniqueConstraint(
          name = "uk_push_user_device",
          columnNames = {"user_type", "user_id", "device_id"})
    })
public class UserPushSubscription {
   ...
   */
  public static UserPushSubscription register(
      Long userId,
      UserType userType,
      String deviceId,
      String endpoint,
  ...
  /**
   * Marks this subscription as having a successful push delivery. Resets the error state and
   * updates the last push timestamp.
   */
