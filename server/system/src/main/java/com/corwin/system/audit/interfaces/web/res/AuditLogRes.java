...
/**
 * Response DTO for audit log entries. Contains all fields of an audit log suitable for API
 * serialization, with {@link JsonLongString} annotations for safe long-number transport.
 *
...
public record AuditLogRes(
    ...
    String traceId,
    String requestId,
    @JsonLongString Long operatorUserId,
