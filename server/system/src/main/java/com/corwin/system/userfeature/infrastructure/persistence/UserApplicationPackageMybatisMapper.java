...
/**
 * MyBatis mapper for paginated queries of {@link com.corwin.system.userfeature.domain.model.UserApplicationPackage}.
 *
...
public interface UserApplicationPackageMybatisMapper {
    ...
    PageData<UserApplicationPackage> page(@Param("keyword") String keyword, @Param("enabled") Boolean enabled,
