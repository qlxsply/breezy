...
public final class SystemFileConfigSpecs {
    ...
    public static final ConfigSpec<FileStorageConfig> STORAGE = new SimpleConfigSpec<>(
            new ConfigKey("system.file.storage"), "system", "file", "文件存储",
            "本地文件存储根路径", FileStorageConfig.class,
            new FileStorageConfig("./data/storage"), 1, 10, ConfigActivationPolicy.RESTART_REQUIRED,
            ConfigEditPolicy.ADMIN_EDITABLE, ConfigInvalidValuePolicy.FAIL_STARTUP,
            List.of(field("basePath", "存储根路径", ConfigFieldType.STRING, 10)), "default",
    ...
    public static final ConfigSpec<FilePreviewPolicy> PREVIEW = new SimpleConfigSpec<>(
            ...
            "文件在线预览最大字节数，0 表示不限制", FilePreviewPolicy.class,
            new FilePreviewPolicy(5_242_880L), 1, 20, ConfigActivationPolicy.DYNAMIC,
            ConfigEditPolicy.ADMIN_EDITABLE, ConfigInvalidValuePolicy.USE_DEFAULT,
            List.of(field("maxSizeBytes", "最大预览字节数", ConfigFieldType.LONG, 10)), "default",
