...
/**
 * Enumeration of auditable action types. Defines the specific operations that can be recorded in an
 * audit trail, such as CREATE, UPDATE, DELETE, and other domain-specific actions.
 *
