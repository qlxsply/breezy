...
import static com.corwin.framework.config.definition.ConfigFieldType.BOOLEAN;
...
public final class SystemUserConfigSpecs {
  ...
  public static final ConfigSpec<UserPreferenceDefaults> USER_PREFERENCE_DEFAULTS =
      new SimpleConfigSpec<>(
          new ConfigKey("system.user.preference-defaults"),
          "system",
          "user",
          "用户偏好默认值",
          "用户未设置个人偏好时使用的公共默认值",
          UserPreferenceDefaults.class,
          new UserPreferenceDefaults(
              UserTimeZoneOption.ASIA_SHANGHAI,
              UserDateTimeFormatOption.YMD_DASH_24H_SECOND,
              UserDateFormatOption.YMD_DASH,
              UserDecimalFormatOption.COMMA_DOT,
              true),
          1,
          10,
          ...
          List.of(
              requiredEnum("timeZone", "默认时区", UserTimeZoneOption.values(), 10),
              ...
              required("adminTabKeepAlive", "默认记忆后台标签页状态", BOOLEAN, 50)),
