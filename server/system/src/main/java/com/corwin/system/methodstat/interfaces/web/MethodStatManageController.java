...
/**
 * REST controller providing management endpoints for method statistics collection switches and data
 * clearing.
 *
...
public class MethodStatManageController {
  ...
  @Authorize(
      userType = UserType.ADMIN,
      permissions = {"mst.switch.edit"})
  public ApiResponse<MethodStatGlobalSwitchRes> updateGlobalSwitch(
      @RequestBody MethodStatGlobalSwitchUpdateReq req) {
  ...
  @Authorize(
      userType = UserType.ADMIN,
      permissions = {"mst.switch.edit"})
  public ApiResponse<MethodStatMethodSwitchRes> updateMethodSwitch(
      @RequestBody MethodStatMethodSwitchUpdateReq req) {
  ...
  @Authorize(
      userType = UserType.ADMIN,
      permissions = {"mst.switch.edit"})
  public ApiResponse<Object> updateAllMethodSwitch(
      @RequestBody MethodStatAllMethodSwitchUpdateReq req) {
