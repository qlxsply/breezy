...
/**
 * AOP method interceptor that collects invocation statistics for methods matching the pointcut. It
 * checks the global and per-method switches, registers metadata, measures execution duration, and
 * publishes an event for asynchronous aggregation.
 *
...
public class MethodStatCollectMethodInterceptor implements MethodInterceptor {
  ...
  public Object invoke(MethodInvocation invocation) throws Throwable {
    ...
    try {
      ...
      MethodStatInvocationEvent event =
          new MethodStatInvocationEvent(
              metadata.key(),
              startedAt,
              finishedAt,
              durationMillis,
