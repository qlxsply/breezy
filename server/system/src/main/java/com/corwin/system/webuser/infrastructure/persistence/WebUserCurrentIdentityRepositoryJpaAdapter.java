 ...
 */
@Repository
public class WebUserCurrentIdentityRepositoryJpaAdapter
    implements WebUserCurrentIdentityRepository {
  ...
  /** {@inheritDoc} */
  @Override
  public Optional<WebUserCurrentIdentity> findByIdentityTypeAndIdentityHash(
  ...
  /** {@inheritDoc} */
  @Override
  public Optional<WebUserCurrentIdentity> findByProviderCodeAndProviderSubject(
