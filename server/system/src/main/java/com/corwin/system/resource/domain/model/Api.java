 ...
 * API metadata entity.
 *
 * <p>Stores runtime information about registered API endpoints, including
 * their module, protocol, HTTP method, path pattern, access control attributes,
 * audit configuration, and sort options.</p>
 *
