...
/**
 * MyBatis mapper for paginated audit log queries. Provides dynamic query execution for the audit
 * log list page using the {@link AuditLogPageQuery} filter and {@link PageSpec} sorting/pagination.
 *
...
public interface AuditLogMybatisMapper {
   ...
   */
  PageData<AuditLog> pageByQuery(
      @Param("query") AuditLogPageQuery query, @Param("spec") PageSpec spec);
}
