...
/**
 * An identity (username, email, phone, or OAuth) bound to a web user account.
 * Each identity can be used for login and is tracked with a normalized hash for lookups.
 *
