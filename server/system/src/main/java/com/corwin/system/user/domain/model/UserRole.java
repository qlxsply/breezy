...
/**
 * Represents the many-to-many association between a user and a role, mapped to the {@code
 * sys_user_role} table.
 *
...
@Table(
    name = "sys_user_role",
    indexes = {
      @Index(name = "idx_sys_user_role_unique", columnList = "user_id,role_id", unique = true),
