 ...
 * 用户功能访问特例。
 *
 * <p>表示单个用户对产品应用内某个功能的单独启用、单独禁用或清除特例。</p>
 *
 * @author Corwin
 */
@Getter
@Entity
@Table(name = "sys_user_feature_override", indexes = {
        @Index(name = "idx_sys_user_feature_override_unique", columnList = "user_id,feature_id", unique = true),
...
public class UserFeatureOverride {
     ...
     */
    public UserFeatureOverride(Long userId, Long applicationId, Long featureId, UserAccessOverrideType overrideType,
