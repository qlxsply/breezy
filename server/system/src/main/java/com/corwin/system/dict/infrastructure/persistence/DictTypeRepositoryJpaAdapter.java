 ...
 *
 * <p>Delegates persistence operations to JpaRepository and MyBatis mapper for complex queries.
 *
...
public class DictTypeRepositoryJpaAdapter implements DictTypeRepository {
  ...
  public PageData<DictType> page(String code, String name, PageSpec spec) {
    return mybatisMapper.page(
        LikePatternUtils.toContainsPattern(code), LikePatternUtils.toContainsPattern(name), spec);
  }
