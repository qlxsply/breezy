...
@Entity
@Table(
    name = "sys_user_application_package_member",
    indexes = {
      @Index(
          name = "idx_sys_user_application_package_member_unique",
          columnList = "package_id,user_id",
          unique = true),
      @Index(
          name = "idx_sys_user_application_package_member_package_id",
