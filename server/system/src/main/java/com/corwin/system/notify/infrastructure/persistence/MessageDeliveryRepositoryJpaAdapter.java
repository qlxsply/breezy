 ...
 *
 * <p>Delegates persistence operations to {@link MessageDeliveryJpaRepository}.
 *
...
public class MessageDeliveryRepositoryJpaAdapter implements MessageDeliveryRepository {
  ...
  @Override
  public Optional<MessageDelivery> findByIdAndUserIdAndUserType(
      Long id, Long userId, UserType userType) {
    return repo.findByIdAndUserIdAndUserType(id, userId, userType);
  }

  @Override
  public List<MessageDelivery> findByUserIdAndUserTypeAndIdGreaterThanOrderByIdAsc(
  ...
  @Override
  public List<MessageDelivery> findByUserIdAndUserTypeAndNotificationId(
  ...
  @Override
  public Optional<MessageDelivery> findFirstByUserIdAndUserTypeOrderByIdDesc(
