 ...
 *
 * <p>Provides use-case orchestration for listing, paginating, enabling/disabling APIs,
 * and updating sort options. Clears the API permission cache on state changes.</p>
 *
