...
/**
 * Represents a system user entity mapped to the {@code sys_user} table. Encapsulates user identity,
 * authentication, status, and lifecycle fields.
 *
...
@Table(
    name = "sys_user",
    indexes = {@Index(name = "idx_sys_user_username", columnList = "username", unique = true)})
public class User {
  ...
  /**
   * Resets the password and clears the last password changed timestamp, forcing the user to change
