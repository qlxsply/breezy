...
public record ConfigValue(
  ...
  public static ConfigValue createOverride(
      String configKey,
      String content,
      int schemaVersion,
      Long updatedBy,
    ...
    return new ConfigValue(
        configKey, content, schemaVersion, 1, true, updatedBy, updatedAt, updateReason);
  }

  public ConfigValue updateOverride(
      String content, int schemaVersion, Long updatedBy, Instant updatedAt, String updateReason) {
    return new ConfigValue(
        configKey,
        content,
        schemaVersion,
  ...
  public ConfigValue resetToDefault(
