...
public class MethodStatQueryController {
  ...
  @Authorize(
      ...
      permissions = {"mst.stat.view"})
  public ApiResponse<PageResult<MethodStatStatsRes>> pageStats(
      @RequestBody MethodStatStatsPageReq req) {
    SortSpec sortSpec = firstSort(req);
    var pageSpec = PageSpecFactory.of(req.page(), req.sort());
    var page =
        queryAppService.pageStats(
            req.methodName(),
            req.collectEnabled(),
  ...
  private static MethodStatStatsRes toStatsRes(MethodStatStatsView view) {
    return new MethodStatStatsRes(
        view.key(),
        view.packageName(),
        view.className(),
        view.methodName(),
        view.methodSignature(),
        view.methodSwitchEnabled(),
        view.globalSwitchEnabled(),
        view.collectEnabled(),
        view.totalCalls(),
        view.totalSuccess(),
        view.totalFailure(),
        view.recent1MinuteCalls(),
        view.recent1HourCalls(),
        view.recent1DayCalls(),
        view.recent1MinuteSuccess(),
        view.recent1MinuteFailure(),
        view.recent1HourSuccess(),
        view.recent1HourFailure(),
        view.recent1DaySuccess(),
        view.recent1DayFailure(),
        view.durationSampleSize(),
        view.durationMax(),
        view.durationMin(),
        view.durationAvg(),
        view.durationP50(),
