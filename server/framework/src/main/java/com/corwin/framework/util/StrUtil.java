 ...
 * <p>
 * Provides common operations such as emptiness/blankness checks, joining,
 * splitting, trimming, and default-value fallbacks, complementing the
 * standard {@link java.lang.String} API.
 *
...
public final class StrUtil {
    ...
    /**
     * Checks whether the given string is {@code null} or contains only
    ...
    /**
     * Joins a collection by applying a mapper function, using the default
     * delimiter ({@code ,}).
     *
    ...
    /**
     * Splits the given string by the default delimiter ({@code ,}),
     * trimming each part.
     *
     ...
     * <p>
     * Uses {@link Pattern#quote(String)} to treat the delimiter as a literal string
     * (not a regex), and a negative limit to preserve trailing empty strings.
     *
     * @param str       the string to split
    ...
    /**
     * Returns the element at the given index after splitting by the
     * default delimiter ({@code ,}), or {@code null} if out of bounds.
     *
     * @param str   the string to split
    ...
    /**
     * Returns the element at the given index after splitting by the
     * specified delimiter, or {@code null} if out of bounds.
     *
     * @param str       the string to split
     * @param delimiter the literal delimiter
     * @param index     the zero-based index of the desired part
