...
/**
 * Default {@link AsyncEventPublisher} that splits publishing into two steps: envelope creation via
 * {@link AsyncEventEnvelopeFactory} and delivery via {@link AsyncEventTransport}. Business code is
 * isolated from context management and transport details.
 *
...
public class DefaultAsyncEventPublisher implements AsyncEventPublisher {
  ...
  public DefaultAsyncEventPublisher(
