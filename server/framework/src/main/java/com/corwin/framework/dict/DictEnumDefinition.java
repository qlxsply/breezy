 ...
 * <p>
 * Provides default implementations for {@link #itemCode()} (enum name),
 * {@link #itemValue()} (alias for code), alongside optional
 * {@link #tagColor()} and {@link #tagType()} for UI tag rendering.
 *
