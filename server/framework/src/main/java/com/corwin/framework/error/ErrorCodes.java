 ...
 *
 * <p>Checks that a code is a six-digit numeric string and falls within its declared range.
 *
...
public final class ErrorCodes {
  ...
  public static void validate(String code, String msg, ErrorCodeRange range) {
    ...
    if (!range.contains(code)) {
      ...
      String s =
          String.format(
              "Error code [%s] is out of range [%s-%s] for range [%s]", code, start, end, name);
