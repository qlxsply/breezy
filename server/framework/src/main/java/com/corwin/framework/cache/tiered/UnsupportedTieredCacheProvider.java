package com.corwin.framework.cache.tiered;
...
/**
 * Placeholder {@link com.corwin.framework.cache.core.CacheProvider} for the local+Redis tiered mode
 * (not yet implemented).
 *
 * @author Corwin 2026/4/19
 */
public class UnsupportedTieredCacheProvider implements CacheProvider {
  ...
  private BizException unsupported() {
    return new BizException(
        "Tiered cache provider is not implemented yet. Current supported cache mode: LOCAL.",
