 ...
 *
 * <p>This class mainly serves legacy interfaces, entities, and third-party libraries that still
 * require {@link Date}. New code should prefer {@link HighDate}; this class acts as a bridge.
 *
 * <p>Core conventions:
 *
 * <ul>
 *   <li>{@link Date} represents an instant on the timeline; it carries no time zone information
 *   <li>Display and parsing of "year-month-day hour:minute:second" are always handled in the system
 *       default time zone
 *   <li>Day-range queries should use {@link #toStartOfDay(Date)} and {@link
 *       #toStartOfNextDay(Date)} with a half-open interval
 * </ul>
 *
 * <pre>{@code
...
public final class LowDate {
  ...
  /** Returns the current {@link Date} instance (timeline instant). Does not depend on time zone. */
  public static Date realDateTime() {
    return Date.from(HighDate.realInstant());
  }

  /**
   * Returns the start-of-day of the current local date in the system default time zone as a {@link
   * Date}.
   */
  ...
  /**
   * Returns the local time-of-day portion of the current instant, carried on the epoch-day-0 date.
   *
   * <p>Note: {@link Date} is not suitable for representing "pure time"; this method exists only for
  ...
  /** Returns the configured current business {@link Date}. Does not depend on time zone. */
  public static Date mockDateTime() {
    return Date.from(HighDate.mockInstant());
  }

  /**
   * Returns the start-of-day of the mocked local date in the system default time zone as a {@link
   * Date}.
   */
  ...
  /**
   * Returns the local time-of-day portion of the mocked instant, carried on the epoch-day-0 date.
   */
  ...
  /**
   * Converts an epoch millis to the start-of-day of the corresponding local date in the system
   * default time zone.
   *
   * @param epochMillis the milliseconds since 1970-01-01T00:00:00Z
  ...
  /**
   * Converts an epoch millis to the local time-of-day portion, carried on the epoch-day-0 date.
   *
   * @param epochMillis the milliseconds since 1970-01-01T00:00:00Z
  ...
  /**
   * Parses a {@code yyyy-MM-dd HH:mm:ss} string into a {@link Date} interpreted in the system
   * default time zone.
   *
  ...
  /**
   * Parses a {@code yyyy-MM-dd} string into a {@link Date} at start-of-day in the system default
   * time zone.
   *
  ...
  /**
   * Parses a {@code HH:mm:ss} string into a {@link Date} carried on the epoch-day-0 date.
   *
   * <p>Note: This is a compatibility wrapper for "pure time"; new code should use {@link LocalTime}
   * directly.
   *
  ...
  /**
   * Formats a {@link Date} to {@code yyyy-MM-dd HH:mm:ss} in the system default time zone.
   *
  ...
  /**
   * Formats a {@link Date} to {@code yyyy-MM-dd} in the system default time zone.
   *
   * @param date the date to format
  ...
  /**
   * Formats a {@link Date} to {@code HH:mm:ss} in the system default time zone.
   *
   * @param date the date to format
  ...
  /**
   * Returns the start-of-day (00:00:00) of the given date-time in the system default time zone.
   *
  ...
  /**
   * Returns the start of the next day (00:00:00) in the system default time zone.
   *
   * <p>Recommended for day-range queries using the half-open interval {@code [startOfDay,
   * startOfNextDay)} to avoid precision ambiguity with end-of-day.
   *
   * @param dateTime the source date-time
  ...
  /**
   * Returns the start of the current month (first day 00:00:00) in the system default time zone.
   *
   * @param dateTime the source date-time
  ...
  /**
   * Returns the start of the next month (first day 00:00:00) in the system default time zone.
   *
   * @param dateTime the source date-time
  ...
  /**
   * Returns the start of the current year (January 1st 00:00:00) in the system default time zone.
   *
   * @param dateTime the source date-time
  ...
  /**
   * Returns the start of the next year (January 1st 00:00:00) in the system default time zone.
   *
   * @param dateTime the source date-time
  ...
  /**
   * Extracts the local time-of-day portion (hour:minute:second:nanos) and returns it as a {@link
   * Date} on the epoch-day-0 base date.
   *
   * <p>Note: {@link Date} is not suited for "pure time"; this exists only for legacy API
   * compatibility.
   *
   * @param dateTime the source date-time
   * @return the local time-of-day as a {@link Date} on epoch-day-0
   ...
   *
   * <p>Unlike {@link TimeZone#getTimeZone(String)}, this method throws an exception for invalid IDs
   * instead of silently falling back to GMT.
   *
   * <p>Example: {@code LowDate.parseTimeZone("Asia/Shanghai")}.
   *
  ...
  /**
   * Converts a {@link LocalDate} to a {@link Date} at start-of-day in the system default time zone.
   *
  ...
  /**
   * Converts a {@link LocalTime} to a compatibility {@link Date} on the epoch-day-0 base date.
   *
  ...
  /**
   * Converts a {@link Date} to a {@link LocalDateTime} in the system default time zone.
   *
   * @param date the date to convert, may be null
  ...
  /**
   * Converts a {@link Date} to a {@link LocalTime} in the system default time zone.
   *
   * @param date the date to convert, may be null
  ...
  /**
   * Formats a {@link Date} using a custom pattern in the system default time zone.
   *
   * @param date the date to format
  ...
  /**
   * Parses a date string using a custom pattern into a {@link Date} at start-of-day.
   *
   * @param str the date string to parse
   * @param pattern the {@link java.time.format.DateTimeFormatter} pattern
   * @return the parsed {@link Date}
  ...
  /**
   * Parses a time string using a custom pattern into a {@link Date} on epoch-day-0.
   *
   * @param str the time string to parse
   * @param pattern the {@link java.time.format.DateTimeFormatter} pattern
   * @return the parsed {@link Date} on epoch-day-0
