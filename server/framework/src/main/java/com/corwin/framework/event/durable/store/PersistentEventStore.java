...
public interface PersistentEventStore {
     ...
     * @return 候选投递列表
     */
    List<PersistedDelivery> loadRecoverableDeliveries(Set<String> consumerGroups, long now, int offset, int limit);
     ...
     * @return 是否 claim 成功
     */
    boolean claimDelivery(String deliveryId, long expectedVersion, String ownerNode, long claimUntil, long now);
     ...
     * @return 是否更新成功
     */
    boolean markDeliverySucceeded(String deliveryId, String eventId, long expectedVersion, long completedAt,
            long updatedAt);
     ...
     * @return 是否更新成功
     */
    boolean markDeliveryFailed(String deliveryId, long expectedVersion, String errorMessage, long updatedAt);
     ...
     * @return 是否更新成功
     */
    boolean markDeliveryCancelled(String deliveryId, String eventId, long expectedVersion, long completedAt,
            long updatedAt);
     ...
     * @return 清理统计
     */
    CleanupResult cleanupCompleted(long deliveryCompletedBefore, long eventCompletedBefore, int batchSize);
}
