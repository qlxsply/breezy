...
/**
 * Date-time format pattern constants and pre-built {@link java.time.format.DateTimeFormatter}
 * instances.
 *
 * <p>Provides ISO-like defaults (yyyy-MM-dd HH:mm:ss, yyyy-MM-dd, HH:mm:ss) that are used
 * consistently across serialization, parsing, and display.
 *
