...
/**
 * Abstraction for invoking a subscriber — regardless of whether it was registered via annotation or
 * another mechanism. Transports depend only on this interface and do not need to know about
 * reflection or bean invocation details.
 *
