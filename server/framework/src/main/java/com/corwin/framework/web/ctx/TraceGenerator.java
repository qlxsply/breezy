 ...
 * <ul>
 *   <li>Fixed length</li>
 *   <li>High randomness ({@link SecureRandom})</li>
 *   <li>Lowercase letters + digits only (ambiguous characters excluded)</li>
 * </ul>
 *
 * @author Corwin
 */
public final class TraceGenerator {
    ...
    /**
     * Ambiguous characters removed from the digit set:
     * 0 o
     * l i
     */
     ...
     * <p>Characteristics:
     * <ul>
     *   <li>Each character encodes 5 bits (32-character alphabet)</li>
     *   <li>Uses the DIGITS array (must have length 32)</li>
     *   <li>Backed by {@link SecureRandom}, suitable for traceId / spanId</li>
     *   <li>Fixed output length, no padding characters</li>
     * </ul>
     *
     * <p>Algorithm outline:
     * <pre>
