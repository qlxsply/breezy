...
/**
 * Composite annotation that serializes {@code Long} / {@code long} as String and deserializes
 * String back to Long.
 *
 * <p>This addresses the precision loss issue that occurs when JavaScript consumes large numeric
