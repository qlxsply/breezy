...
public final class SimpleConfigSpec<T> implements ConfigSpec<T> {
    ...
    public SimpleConfigSpec(ConfigKey key, String module, String group, String title, String description,
            Class<T> valueClass, T defaultValue, int schemaVersion, int order, ConfigActivationPolicy activationPolicy,
            ConfigEditPolicy editPolicy, ConfigInvalidValuePolicy invalidValuePolicy, List<ConfigFieldSpec> fields,
            String editorId, ConfigValidator<T> runtimeValidator, ConfigValidator<T> publishValidator) {
        ...
        this.invalidValuePolicy = Objects.requireNonNull(invalidValuePolicy, "invalidValuePolicy required");
