...
public class LocalCacheStringOps extends AbstractLocalCacheOps implements CacheStringOps {
    ...
    public Optional<String> get(String key) {
        ...
        return store.read(dataType(), key, entry -> Optional.of((String) entry.getValue()), Optional::empty);
    }
    ...
    public long increment(String key, long delta) {
        ...
        return store.write(dataType(), key, (entry, now) -> {
            ...
            CacheEntry updated = entry == null ? CacheEntry.create(dataType(), Long.toString(updatedValue), now,
                    null) : new CacheEntry(dataType(), Long.toString(updatedValue), entry.getCreatedAt(), now,
                    expireAt);
    ...
    private long parseLong(String key, String value) {
        try {
            ...
            throw new BizException("Cache key '" + key + "' does not contain a valid long value",
