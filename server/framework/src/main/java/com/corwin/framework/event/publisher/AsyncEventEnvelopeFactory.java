...
/**
 * Factory that converts a business {@link AsyncEvent} into a fully-populated {@link
 * AsyncEventEnvelope}, filling in event ID, timestamp, context snapshot, source, and producer
 * metadata.
 *
