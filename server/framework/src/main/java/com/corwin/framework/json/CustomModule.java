...
public class CustomModule extends SimpleModule {
    ...
    public CustomModule() {
        ...
        // ======================= 时间序列化规则 ===============================
        this.addSerializer(LocalDateTime.class, new LocalDateTimeSerializer(DateTimePatterns.DATE_TIME_FMT));
        ...
        // ======================= 时间反序列化规则 ==============================
        this.addDeserializer(LocalDateTime.class, new LocalDateTimeDeserializer(DateTimePatterns.DATE_TIME_FMT));
        ...
        // ======================= Date反序列化规则 ===============================
        this.addDeserializer(Date.class, new DatePatternDeserializer(DateTimePatterns.DATE_TIME_PATTERN));
    }
