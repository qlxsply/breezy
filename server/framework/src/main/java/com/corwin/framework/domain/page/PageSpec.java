 ...
 *
 * <p>Provides factory methods and defaults ({@value #DEFAULT_PAGE_NO}, {@value
 * #DEFAULT_PAGE_SIZE}). Page numbers are 1-based; values less than 1 are normalized to the default.
 *
 ...
 */
public record PageSpec(int pageNo, int pageSize, List<SortSpec> sorts) {
