...
public class JsonFmtRecord {
  ...
  public static JsonFmtRecord createInline(
      Long userId, String name, String content, Integer orderNo) {
  ...
  public static JsonFmtRecord createWithFile(
      Long userId, String name, String contentFileId, Integer orderNo) {
    JsonFmtRecord record = new JsonFmtRecord();
    record.id = UUID.randomUUID().toString();
    record.userId = normalizeUserId(userId);
    record.name = normalizeName(name);
