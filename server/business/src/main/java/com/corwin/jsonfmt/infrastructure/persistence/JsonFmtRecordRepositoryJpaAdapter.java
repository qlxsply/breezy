...
public class JsonFmtRecordRepositoryJpaAdapter implements JsonFmtRecordRepository {
  ...
  @Override
  public List<JsonFmtRecord> findByUserIdAndNameContainingIgnoreCaseOrderByOrderNoAsc(
  ...
  @Override
  public long countByUserIdAndCreatedAtGreaterThanEqualAndCreatedAtLessThan(
      Long userId, Instant startAt, Instant endAt) {
    return repo.countByUserIdAndCreatedAtGreaterThanEqualAndCreatedAtLessThan(
