...
public class DatabaseSourceRepositoryJpaAdapter implements DatabaseSourceRepository {
  ...
  @Override
  public Optional<DatabaseSource> findByDbTypeAndJdbcUrlAndUsername(
  ...
  private DatabaseSourcePageQuery normalizeQuery(DatabaseSourcePageQuery query) {
    ...
    return new DatabaseSourcePageQuery(
        query.dbType(), LikePatternUtils.toContainsPattern(query.nameLike()));
  }
}
