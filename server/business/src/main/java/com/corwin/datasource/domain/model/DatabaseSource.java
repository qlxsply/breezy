...
public class DatabaseSource {
  ...
  public static DatabaseSource createUser(
      String name,
      DatabaseType dbType,
      String jdbcUrl,
      String username,
  ...
  public static DatabaseSource createApp(
      String name,
      DatabaseType dbType,
      String jdbcUrl,
      String username,
  ...
  public void updateAppConfig(
      String name, DatabaseType dbType, String jdbcUrl, String username, String appDsKey) {
    this.name = name;
    this.dbType = dbType;
    this.jdbcUrl = jdbcUrl;
    this.username = username;
