...
@Getter
@Entity
@Table(name = "db_schema", indexes = {@Index(name = "idx_db_schema_source", columnList = "data_source_id")},
        uniqueConstraints = {
                @UniqueConstraint(name = "uk_db_schema_name", columnNames = {"data_source_id", "database_name"})})
public class DatabaseSchema {
    ...
    public static DatabaseSchema create(Long dataSourceId, String databaseName, String alias, String remarkCustom) {
    ...
    public void updateMetadata(String productName, String productVersion, String driverName, String driverVersion,
            Instant fetchedAt) {
