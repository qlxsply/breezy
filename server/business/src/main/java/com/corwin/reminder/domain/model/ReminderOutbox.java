...
@Getter
@Entity
@Table(name = "reminder_outbox", indexes = {@Index(name = "idx_reminder_due_time", columnList = "due_time"),
...
public class ReminderOutbox {
    ...
    public static ReminderOutbox pending(Long userId, String dedupeKey, SourceType sourceType, Long sourceId, Instant dueTime,
