...
public class RecurrenceRule {
  ...
  /** WEEKLY：每周的哪些天触发 用 bitmask 持久化，避免 ElementCollection 额外表 */
  ...
  /** 结束条件：最多发生次数 注意：要严格支持 count，需要存储“已发生次数”或 occurrence 明细，这里先预留字段。 */
  ...
  public static RecurrenceRule yearly(
      int interval, int monthOfYear, int dayOfMonth, Instant until) {
