...
@Getter
@Entity
@Table(name = "schedule_event", indexes = {@Index(name = "idx_schedule_start_time", columnList = "start_time"),
...
public class ScheduleEvent {
    ...
    public void update(String title, Instant startTime, Instant endTime, String eventTimeZoneId, RecurrenceRule rule,
        ...
        this.eventTimeZoneId = Objects.requireNonNull(eventTimeZoneId, "eventTimeZoneId required").trim();
