...
public class TodoAttachmentAppService {
    ...
    public String upload(MultipartFile file) {
        ...
        UploadFileCommand command = new UploadFileCommand(OwnerType.APPLICATION, "todo", null,
    ...
    public TodoAttachmentFileView view(String fileId) {
        ...
        return new TodoAttachmentFileView(view.name(), view.contentType(), fileCommandPort.readFileContent(fileId));
    }

    private TodoAttachmentMetaView toMetaView(StorageNodeView view) {
        return new TodoAttachmentMetaView(view.id(), view.name(), view.size(), view.contentType(), view.createdAt(),
                view.updatedAt());
    }
