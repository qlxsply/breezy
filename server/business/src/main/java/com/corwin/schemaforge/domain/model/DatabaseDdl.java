...
public class DatabaseDdl {
    ...
    public DatabaseDdl(Long managedDatabaseId, String sourceSnapshotId, String targetSnapshotId,
                       String name, String remark, String dbType, String dbVersion,
                       String schemaName, String logicalFileId, String contentHash) {
        this.id = UUID.randomUUID().toString();
        this.managedDatabaseId = Objects.requireNonNull(managedDatabaseId, "managedDatabaseId required");
